...
def yolo_to_coco(yolo_annotations, image_dir, output_file):
    ...
    # Add categories to the COCO annotations
...
def main():
    ...
    parser.add_argument('yolo_annotations', help='Directory containing YOLO annotation .txt files')
    parser.add_argument('image_dir', help='Directory containing corresponding images')
    parser.add_argument('output_file', help='Output JSON file to save COCO annotations')

    args = parser.parse_args()

    yolo_to_coco(args.yolo_annotations, args.image_dir, args.output_file)
